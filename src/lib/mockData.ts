...
export const aiRecommendations: AIRecommendation[] = [
  {
    ...
    detail:
      'Your Email Drip campaign is generating ₹94,200 revenue on just ₹18,000 spend. This is your highest-ROI channel by a significant margin. Increasing budget to ₹45,000 could yield an estimated ₹2.3L in additional revenue.',
  ...
  },
  {
    ...
    detail:
      'The YouTube PreRoll campaign has spent ₹42,800 but only generated ₹58,200 in revenue with just 89 conversions. CPA of ₹481 is 3.4× higher than your Email channel. Reallocating this budget to Google Retargeting could improve overall ROI by 18%.',
  ...
  },
  {
    ...
    detail:
      'Meta Reels has a 2.48% CTR (above industry average) but your conversion rate is only 1.86%. High clicks with low conversions typically indicates landing page friction. A/B test your CTA placement and reduce form fields to improve conversion by an estimated 0.8–1.2%.',
  ...
  },
  {
    ...
    detail:
      'Your retargeting campaign is converting at 4.2% with a CPA of ₹92.7 — your best CPA across all paid channels. Current budget of ₹45,000 is far below optimal. Recommend scaling to ₹90,000 to capture warm audience before they convert via competitors.',
  ...
  },
  {
    ...
    detail:
      'LinkedIn drives quality B2B leads but the cost per acquisition is 15× higher than Email. For your current stage, recommend capping LinkedIn at ₹60,000/month and reallocating the remaining ₹60,000 to Google Search where ROI is proven.',
