...
export const metadata: Metadata = {
  title: 'GrowthLens — AI Marketing Decision Intelligence',
  description:
    'GrowthLens helps Indian businesses analyze ad campaign performance and get AI-powered budget reallocation recommendations from one dashboard.',
  icons: {
